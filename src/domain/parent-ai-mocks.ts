...
export function mockParentAssistantResponse(intent: ParentAssistantIntent, childName: string) {
  if (intent === "lesson") return { title: `Oui — je peux préparer une révision pour ${childName}`, body: `${childName} a déjà une base sur les fractions. La priorité est de comparer deux fractions et d’expliquer le raisonnement, plutôt que de refaire toute la leçon. Je vais préparer une activité de 20 minutes avec une question guidée; le brouillon restera à valider.`, sources: ["Progression récente", "Cours Fractions"], action: "Créer une révision", followUps: [{ label: "Créer le brouillon", prompt: "Créer une révision de fractions de 20 minutes" }, { label: "Voir l’objectif du cours", prompt: "Quel est l’objectif actuel du cours Fractions ?" }, { label: "Changer la durée", prompt: "Créer une révision de fractions de 10 minutes" }] };
  if (intent === "week") return { title: `Voici quoi faire cette semaine pour ${childName}`, body: `Je recommande d’abord 20 minutes de fractions mardi, puis une activité de sciences jeudi. Le plan laisse environ 45 minutes libres; cela respecte le rythme actuel sans ajouter une séance inutile.`, sources: ["Progression récente", "Plan de la semaine"], action: "Créer une révision", followUps: [{ label: "Voir le plan détaillé", prompt: "Montre-moi le plan détaillé de cette semaine" }, { label: "Réserver mardi 20 min", prompt: "Planifie 20 minutes de révision mardi" }, { label: "Préparer la séance", prompt: "Créer une révision pour cette semaine" }] };
  if (intent === "progress") return { title: `La semaine d’apprentissage de ${childName} en un coup d’œil`, body: `Très bon rythme cette semaine : ${childName} a complété 9 activités sur 11 et progresse particulièrement en sciences. Le seul point qui ralentit encore son raisonnement est la comparaison de fractions lorsque les dénominateurs sont différents. Voici les faits observés et la priorité que je recommande pour la prochaine séance.`, sources: ["Activités des 14 derniers jours", "Preuves d’apprentissage"], progressReport: { metrics: [{ label: "Activités terminées", value: "9 / 11", detail: "+2 vs semaine passée", tone: "green" }, { label: "Temps actif", value: "2 h 45", detail: "16 min / jour en moyenne", tone: "blue" }, { label: "Réussite moyenne", value: "86 %", detail: "+8 points cette semaine", tone: "gold" }, { label: "Aide demandée", value: "3 fois", detail: "surtout en fractions", tone: "purple" }], rows: [{ subject: "Mathématiques", completed: "4 / 5", score: "78 %", trend: "↗ +5 %", status: "À consolider", tone: "gold" }, { subject: "Sciences", completed: "3 / 3", score: "94 %", trend: "↗ +12 %", status: "Très solide", tone: "green" }, { subject: "Français", completed: "2 / 2", score: "88 %", trend: "→ Stable", status: "En bonne voie", tone: "blue" }, { subject: "Lecture", completed: "1 / 1", score: "91 %", trend: "↗ +4 %", status: "Très solide", tone: "purple" }], strengths: ["Explique bien son raisonnement à l’oral", "Commence ses activités sans rappel", "Réussit les exercices courts de sciences"], focus: { title: "Fractions : comparer des dénominateurs différents", detail: "3 hésitations observées sur 5 exercices; l’erreur arrive après la lecture de la question, pas dans le calcul final.", priority: "Priorité 1" } }, action: "Voir les preuves", followUps: [{ label: "Voir les preuves détaillées", prompt: `Montre les preuves d’apprentissage de ${childName}` }, { label: "Comparer la semaine passée", prompt: `Compare la progression de ${childName} avec la semaine passée` }, { label: "Planifier 20 min de fractions", prompt: `Planifie une courte révision de fractions pour ${childName}` }] };
