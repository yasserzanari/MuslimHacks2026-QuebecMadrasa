...
const copy = {
  fr: {
    nav: [["⌂", "Accueil", "/parent"], ["☷", "Plan de la semaine", "/parent/plan"], ["▣", "Cours", "/parent/cours"], ["✦", "Assistant IA", "#"], ["◌", "Communauté", "#"], ["▤", "Portfolio", "#"], ["◫", "Parcours Québec", "/parent/parcours-quebec"], ["$", "Budget", "#"]],
    sideLabel: "Famille",
  ...
  en: {
    nav: [["⌂", "Home", "/parent"], ["☷", "Weekly plan", "/parent/plan"], ["▣", "Courses", "/parent/cours"], ["✦", "AI Assistant", "#"], ["◌", "Community", "#"], ["▤", "Portfolio", "#"], ["◫", "Quebec pathway", "/parent/parcours-quebec"], ["$", "Budget", "#"]],
    sideLabel: "Family",
