...
export default function StudentLessonPage() {
  ...
  return <main className="lesson-kids-shell">
    <aside className="lesson-kids-sidebar"><Link href="/student" className="lesson-kids-logo"><img src="/ui/logo-madrasa-quebec.png" alt="Madrasa Québec Network" /></Link><nav><Link href="/student">☀ <span>Aujourd’hui</span></Link><Link className="active" href="/student/cours">▣ <span>Mes cours</span></Link><Link href="/student/jouer">◈ <span>Jouer</span></Link><Link href="/student/progression">▥ <span>Ma progression</span></Link></nav><div className="kids-side-footer">✦<br /><small>{locale === "fr" ? "Ton tuteur t’aide à réfléchir." : "Your tutor helps you think."}</small></div></aside>
